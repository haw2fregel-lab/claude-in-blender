...
https://github.com/user-attachments/assets/5360f544-db83-4bfa-bd46-55fa784422f7
...
パネル最上段の **Work dir** が、依頼を動かす作業ディレクトリです。**このリポである必要はありません**——自分のプロジェクトを指定すれば、そのリポの `CLAUDE.md` やスキルがそのまま効きます。ドロップダウン隣の **＋** で、ファイルブラウザからその場で選べます（一度きり——履歴には残りません）。履歴に登録するには、このリポで次を実行してください。
